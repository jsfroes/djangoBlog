...
SECRET_KEY = '605+!(@u7&q_$ew&5ai_)mf4sm651m8ky@a%596()armywq%6c'
...
# MEDIA_ROOT -> Path to where we would like Django to store uploaded files
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
# MEDIA_URL -> URL to access the images
MEDIA_URL = '/media/'
...
#set send email with gmail variables
